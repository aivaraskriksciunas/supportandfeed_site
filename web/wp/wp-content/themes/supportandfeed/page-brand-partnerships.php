<?php 
    ...
    function load_brand_partnerships_page_assets() {
        $assets_dir = get_stylesheet_directory_uri() . '/assets/dist/';

        wp_enqueue_style( 'page-brand-partnerships', $assets_dir . 'page-brand-partnerships.css', ver:'1.0.0' );
    }

    add_action( 'wp_enqueue_scripts', 'load_brand_partnerships_page_assets' );
?>
